...
for (let i = 0; i < colors1.length; i++) {
  const c = colors1[i];
  console.log(`Seed1-Color${i}: R=${c.R.toFixed(6)} G=${c.G.toFixed(6)} B=${c.B.toFixed(6)} Hex=${c.Hex()}`);
}
...
for (let i = 0; i < happyColors.length; i++) {
  ...
  console.log(`Seed1-Happy${i}: R=${c.R.toFixed(6)} G=${c.G.toFixed(6)} B=${c.B.toFixed(6)} Hex=${c.Hex()}`);
}
...
for (let i = 0; i < colors42.length; i++) {
  const c = colors42[i];
  console.log(`Seed42-Color${i}: R=${c.R.toFixed(6)} G=${c.G.toFixed(6)} B=${c.B.toFixed(6)} Hex=${c.Hex()}`);
}